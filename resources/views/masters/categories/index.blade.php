...
<div class="flex-1 overflow-y-auto p-5 space-y-4 pb-20 bg-[#f8fafc]">
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
            ...
            <h1 class="text-2xl font-black text-slate-900 tracking-tight">Category Master</h1>
        </div>
...
<script>
    $(document).ready(function () {
        ...
        const table = $('#category-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('masters.categories.index') }}",
        ...
        $('#floating-edit').click(function() {
            ...
            editMode = true;
            $.get(`{{ url('') }}/masters/categories/${id}/edit`, function(data) {
        ...
        $('#CategoryForm').submit(function(e) {
            ...
            const url = editMode
                ...
                : "{{ route('masters.categories.store') }}";
      ...
      window.handleBulkDelete = () => {
        ...
        $.ajax({
            url: "{{ route('masters.categories.bulkDelete') }}",
            type: "POST",
            data: { ids: ids },
