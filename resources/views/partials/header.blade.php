    ...
    <div class="flex-grow-1 d-flex align-items-center gap-4">
        ...
        <div class="position-relative w-100" style="max-width: 400px;">
            ...
            <input type="text" class="form-control rounded-4 border-0 bg-white bg-opacity-50 ps-5"
                placeholder="Search leads, systems, or orders..." style="padding-top: 0.6rem; padding-bottom: 0.6rem;">
        </div>
    </div>
    ...
    <div class="d-flex align-items-center gap-3">
        <div class="d-flex gap-2 border-end pe-3 border-secondary-subtle">
            <button class="btn btn-light bg-opacity-50 rounded-4 p-2 d-flex position-relative">
                ...
                <span
                    class="position-absolute top-0 end-0 mt-2 me-2 bg-brand-green rounded-circle border border-2 border-white"
        ...
        <div class="dropdown">
            <div class="d-flex align-items-center gap-3 cursor-pointer" data-bs-toggle="dropdown" aria-expanded="false"
                ...
                <div class="text-end d-none d-sm-block">
                    ...
                    <p class="mb-0 text-brand-blue fw-bold text-uppercase mt-1"
                        ...
                        @elseif(Auth::guard('fabricator')->check())
                            Fabricator
                        @else
                            Guest
                        @endif
            ...
            <ul class="dropdown-menu dropdown-menu-end border-0 rounded-4 mt-2 p-2 shadow-xl"
                ...
                <li>
                    <div class="px-3 py-2">
                        <p class="mb-0 small fw-black text-muted text-uppercase tracking-widest"
                            style="font-size: 10px;">Account Management</p>
                    </div>
                </li>
                <li>
                    <a class="dropdown-item d-flex align-items-center gap-2 py-2.5 rounded-3 hover:bg-light"
                        href="#">
                ...
                <li>
                    <a class="dropdown-item d-flex align-items-center gap-2 py-2.5 rounded-3 text-danger hover:bg-danger-subtle"
                        href="#"
