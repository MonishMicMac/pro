...
<style>
    ...
    .th-group { border-bottom: 2px solid rgba(203, 213, 225, 0.5); padding-bottom: 4px; margin-bottom: 4px; display: block; }
</style>
            ...
            <table class="w-full" id="consolidate-table">
                <thead>
                    ...
                    <tr class="text-left text-[9px] font-bold text-slate-500 uppercase tracking-wide">
                        ...
                        {{-- Totals Sub-columns (ADDED JOINT/INDV) --}}
