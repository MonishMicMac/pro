...
@section('title', 'Fabricator Payment Report')
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
            <nav class="flex items-center gap-1 text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">
                ...
                <span class="text-blue-600">Fabricator Payments</span>
            </nav>
            <h1 class="text-2xl font-black text-slate-900 tracking-tight">Fabricator Payment Report</h1>
        </div>
    </div>
    ...
    <div class="glass-panel rounded-none overflow-hidden relative z-10">
        <div class="p-6">
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h2 id="detail-title" class="text-lg font-black text-slate-800 tracking-tight">Payment Records</h2>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-xs" id="payment-report-table">
                    <thead>
...
<script>
    $(document).ready(function() {
        const table = $('#payment-report-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{ route('fabricator.report.payments.data') }}",
                data: function (d) {
            ...
            columns: [
                ...
                { 
                    ...
                    render: function(data) {
                        return `<span class='px-2 py-0.5 rounded-[4px] text-[9px] font-black uppercase tracking-wider bg-slate-100 text-slate-700'>${data}</span>`;
                    }
                },
