        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div>
                ...
                <select id="filter_status" class="form-input-custom">
                    ...
                    <option value="Pending">Pending / Not Visited</option>
                </select>
            </div>
...
<script>
    $(document).ready(function() {
            ...
            columns: [
                ...
                { 
                    ...
                    render: function(data) {
                        const style = data === 'Scheduled' ? 'bg-purple-100 text-purple-600' : 'bg-slate-100 text-slate-600';
        ...
        $('#btn_reset').click(function() {
            $('#filter_user_id, #filter_status').val('');
