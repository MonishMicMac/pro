...
class LeadController extends Controller
{
    ...
    Log::info('Site Identification Request Received:', $request->all());
...
//     }
    ...
    public function leadCheckOut(Request $request)
    {
        ...
        $rules = [
            ...
            // --- NEW: Work Type & BDM ID Validation ---
            // work_type is always required
            'work_type' => 'required|in:Individual,Joint Work',
            // bdm_id is required ONLY if work_type is "Joint Work"
        ...
        try {
            ...
            // 7. Checkout the Visit (Update Out Time & Work Type Data)
            $visit->update([
                'out_time' => Carbon::now()->toTimeString(),
                'outlat' => $request->outlat,
                'outlong' => $request->outlong,
                ...
                // --- NEW: Update Work Type & BDM ---
                'work_type' => $request->work_type,
                // Only save bdm_id if type is Joint Work, otherwise null
